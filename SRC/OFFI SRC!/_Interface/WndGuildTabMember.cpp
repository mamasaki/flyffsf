...
//		else
		if(::GetLanguage() == LANG_ENG || ::GetLanguage() == LANG_VTN)
			...
			pWndButton->SetTexture( m_pApp->m_pd3dDevice, MakePath( "Theme\\", ::GetLanguage(), "ButtGuildMemberTabMLevel.bmp" ), 0xffff00ff );
	}
...
//		else
		if(::GetLanguage() == LANG_ENG || ::GetLanguage() == LANG_VTN)
			...
			pWndButton->SetTexture( m_pApp->m_pd3dDevice, MakePath( "Theme\\", ::GetLanguage(), "ButtGuildMemberTabJob.bmp" ), 0xffff00ff );
	}
...
//		else
		if(::GetLanguage() == LANG_ENG || ::GetLanguage() == LANG_VTN)
			...
			pWndButton->SetTexture( m_pApp->m_pd3dDevice, MakePath( "Theme\\", ::GetLanguage(), "ButtGuildMemberTabLevel.bmp" ), 0xffff00ff );
	}
...
//		else
		if(::GetLanguage() == LANG_ENG || ::GetLanguage() == LANG_VTN)
			...
			pWndButton->SetTexture( m_pApp->m_pd3dDevice, MakePath( "Theme\\", ::GetLanguage(), "ButtGuildMemberTabChar.bmp" ), 0xffff00ff );
	}
...
//		else
		if(::GetLanguage() == LANG_ENG || ::GetLanguage() == LANG_VTN)
			...
			pWndButton->SetTexture( m_pApp->m_pd3dDevice, MakePath( "Theme\\", ::GetLanguage(), "ButtGuildMemberTabAlias.bmp" ), 0xffff00ff );
	}
#endif //__CSC_VER12_2
