...
//		if(::GetLanguage() == LANG_KOR || ::GetLanguage() == LANG_FRE || ::GetLanguage() == LANG_TWN || ::GetLanguage() == LANG_HK)
		if(::GetLanguage() == LANG_ENG || ::GetLanguage() == LANG_VTN)
			...
			pWndButton->SetTexture( m_pApp->m_pd3dDevice, MakePath( "Theme\\", ::GetLanguage(), "ButtMessengerChannel.bmp" ), 0xffff00ff );
	}
...
//		if(::GetLanguage() == LANG_KOR || ::GetLanguage() == LANG_FRE || ::GetLanguage() == LANG_TWN || ::GetLanguage() == LANG_HK)
		if(::GetLanguage() == LANG_ENG || ::GetLanguage() == LANG_VTN)
			...
			pWndButton->SetTexture( m_pApp->m_pd3dDevice, MakePath( "Theme\\", ::GetLanguage(), "ButtMessengerState.bmp" ), 0xffff00ff );
	}
...
//		if(::GetLanguage() == LANG_KOR || ::GetLanguage() == LANG_FRE || ::GetLanguage() == LANG_TWN || ::GetLanguage() == LANG_HK)
		if(::GetLanguage() == LANG_ENG || ::GetLanguage() == LANG_VTN)
			...
			pWndButton->SetTexture( m_pApp->m_pd3dDevice, MakePath( "Theme\\", ::GetLanguage(), "ButtMessengerLevel.bmp" ), 0xffff00ff );
	}
...
//		if(::GetLanguage() == LANG_KOR || ::GetLanguage() == LANG_FRE || ::GetLanguage() == LANG_TWN || ::GetLanguage() == LANG_HK)
		if(::GetLanguage() == LANG_ENG || ::GetLanguage() == LANG_VTN)
			...
			pWndButton->SetTexture( m_pApp->m_pd3dDevice, MakePath( "Theme\\", ::GetLanguage(), "ButtMessengerJob.bmp" ), 0xffff00ff );
	}
...
//		if(::GetLanguage() == LANG_KOR || ::GetLanguage() == LANG_FRE || ::GetLanguage() == LANG_TWN || ::GetLanguage() == LANG_HK)
		if(::GetLanguage() == LANG_ENG || ::GetLanguage() == LANG_VTN)
			...
			pWndButton->SetTexture( m_pApp->m_pd3dDevice, MakePath( "Theme\\", ::GetLanguage(), "ButtMessengerChar.bmp" ), 0xffff00ff );
	}
