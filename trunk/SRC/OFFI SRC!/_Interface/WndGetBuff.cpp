...
CWndGetBuff::CWndGetBuff() 
{ 
} 
CWndGetBuff::~CWndGetBuff() 
{ 
} 
void CWndGetBuff::OnDraw( C2DRender* p2DRender ) 
{ 
} 
void CWndGetBuff::OnInitialUpdate() 
{ 
...
BOOL CWndGetBuff::Initialize( CWndBase* pWndParent, DWORD /*dwWndId*/ ) 
{
	...
	{
		return CWndNeuz::InitDialog( g_Neuz.GetSafeHwnd(), APP_ONLINEEXPCONFIRM1, 0, CPoint( 0, 0 ), pWndParent );
	}
	if(!_tcscmp(m_szCharacterKey,"MaFl_Helper_ver12.1"))
	{
		return CWndNeuz::InitDialog( g_Neuz.GetSafeHwnd(), APP_ONLINEEXPCONFIRM2, 0, CPoint( 0, 0 ), pWndParent );
	}
...
void CWndGetBuff::OnLButtonUp( UINT nFlags, CPoint point ) 
{ 
} 
void CWndGetBuff::OnLButtonDown( UINT nFlags, CPoint point ) 
{ 
} 
BOOL CWndGetBuff::OnChildNotify( UINT message, UINT nID, LRESULT* pLResult ) 
{ 
	switch(nID)
	{
