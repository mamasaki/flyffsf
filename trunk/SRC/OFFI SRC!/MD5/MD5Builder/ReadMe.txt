================================================================================
    MICROSOFT 基础类库： MD5Builder 项目概述
===============================================================================

应用程序向导已为您创建了此 MD5Builder 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 MD5Builder 应用程序的每个文件的内容摘要。
...
MD5Builder.h
    ...
    CMD5BuilderApp 应用程序类。

MD5Builder.cpp
    这是包含应用程序
    类 CMD5BuilderApp 的主应用程序源文件。
...
应用程序向导将创建一个对话框类：
MD5BuilderDlg.h、MD5BuilderDlg.cpp - 对话框
    这些文件包含 CMD5BuilderDlg 类。  此类定义
    应用程序主对话框的行为。  此对话框的模板包含在 
    MD5Builder.rc 中，而此文件可以在 Microsoft Visual C++ 中进行编辑。
/////////////////////////////////////////////////////////////////////////////

其他标准文件：

StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 MD5Builder.pch 的预编译头文件 (PCH)
