...
//	ON_MSG( PACKETTYPE_OPEN_BATTLESERVER,&CDPDBSrvr:: OnOpenBattleServer );
//	ON_MSG( PACKETTYPE_CLOSE_BATTLESERVER, &CDPDBSrvr::OnCloseBattleServer );
#ifdef __SERVERLIST0911
	ON_MSG( PACKETTYPE_SERVER_ENABLE,&CDPDBSrvr:: OnServerEnable );
#endif	// __SERVERLIST0911
/*
#ifdef __S0114_RELOADPRO
	ON_MSG( PACKETTYPE_RELOAD_PROJECT, &CDPDBSrvr::OnCompleteReloadProject );
#endif // __S0114_RELOADPRO
*/
}
